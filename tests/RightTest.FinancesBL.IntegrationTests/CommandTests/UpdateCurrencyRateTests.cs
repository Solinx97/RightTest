...
public class UpdateCurrencyRateTests(PostgresqlFixture fixture) : IAsyncLifetime
{
    ...
    [Fact]
    public async Task UpdateCurrencyRateCommand_ShouldUpdateExistCurrencyByRate()
    {
        ...
        await _mediator.Send(new UpdateCurrencyRateCommand(id, newRate));
        ...
        Assert.Equal(currency.Rate, newRate);
    }
}
